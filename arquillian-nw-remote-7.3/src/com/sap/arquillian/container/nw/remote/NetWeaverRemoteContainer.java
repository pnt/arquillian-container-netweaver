...
import com.sap._2009._11._24.deployws.Application;
import com.sap._2009._11._24.deployws.ArchiveFile;
import com.sap._2009._11._24.deployws.DeployFault;
import com.sap._2009._11._24.deployws.DeployWSPortType;
import com.sap._2009._11._24.deployws.DeployWSServiceLocator;
...
public class NetWeaverRemoteContainer implements
	...
	public ProtocolMetaData deploy(Archive<?> archive)
		...
		HTTPContext httpCtx = new HTTPContext(config.getServerAddress(),
				config.getServerPort());
		httpCtx.add(new Servlet("ArquillianServletRunner",
				"/arquillian-protocol"));
		protocolMetaData.addContext(httpCtx);
	...
	public void undeploy(Archive<?> archive) throws DeploymentException {
		...
		app.setName(archive.getName().substring(0,
				archive.getName().indexOf(".")));

		try {
			svc.undeploy(new Application[] { app }, null);
		} catch (DeployFault e) {
			throw new RuntimeException("Unable to undeploy application "
					+ app.getName(), e);
		} catch (RemoteException e) {
			throw new RuntimeException(e);
		}

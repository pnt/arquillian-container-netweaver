package com.sap.arquillian.testenricher.nw.ejb;
...
public class NetWeaverEJBInjectionEnricher extends EJBInjectionEnricher {
	...
	public NetWeaverEJBInjectionEnricher() {
...
//		System.out.println("jndi");
		...
		if (isMappedNameSet) {
			...
			jndiNames = new String[] {
					"ejb:/appName=JavaEE/test, jarName=FirstTest.jar, beanName=InfoProvider, interfaceName=com.sap.nw.arquillian.testapp.InfoProviderLocal",
	...
	protected Context createContext() throws Exception {
		...
		props.put(Context.PROVIDER_URL, config.getServerAddress() + ":50004");
